...
public class JavaScript {
	...
	public void llenarFormulario() {
		try {
			...
			List<WebElement> paises = driver.findElements(By.name("country"));
			for (WebElement pais : paises) {
				if (pais.getAttribute("value").equalsIgnoreCase("ARGENTINA")) {
					pais.click();
					resaltar(pais);
				}
			}
			...
			new Select(listaPaises).selectByVisibleText("ANDORRA");
