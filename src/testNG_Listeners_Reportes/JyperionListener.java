...
public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		 ...
		 */
		String archivo = System.getProperty("user.dir") + "screenshot" + new Random().nextInt() + ".png";
		try {
			Util.takeScreenShot(Util.setUpManual(), archivo);
		} catch (IOException e) {
		...
		if (throwable != null) {
			...
			Chunk imdb = new Chunk("[SCREENSHOT]", new Font(Font.HELVETICA, Font.DEFAULTSIZE, Font.UNDERLINE));
			imdb.setAction(new PdfAction("file:///" + archivo));
